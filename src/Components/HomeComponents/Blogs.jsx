  ...
  const blogs = [
    {
      ...
      summary: "Sharing food goes beyond just feeding someone. It builds empathy, saves resources, and strengthens our society.",
      date: "June 10, 2025"
    },
    {
      title: "Food Safety Tips Every Donor Should Know",
      image: "https://i.ibb.co/MHMfQZF/banner1.jpg",
      summary: "Safe food handling is key to making sure donations help rather than harm. Learn how to donate responsibly.",
      date: "June 5, 2025"
    },
    {
      title: "Why Reducing Food Waste Matters in 2025",
      image: "https://i.ibb.co/KxZyNGwq/banner3.jpg",
      summary: "Wasting food is a global problem. See how you can take small actions to make a huge environmental difference.",
      date: "May 29, 2025"
    }
  ];
